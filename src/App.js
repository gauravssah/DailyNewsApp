      ...
      <div>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route exact path='/DailyNewsApp' element={<News setProgress={this.setProgress} key="general" apiKey={this.apiKey} pagesize={this.pagesize} country="in" category="general" />} />
